  ...
  cat <<'EOF'
{
  "hookSpecificOutput": {
    ...
    "additionalContext": "Reminder: If this edit introduced a new function, class, or component, update .claude/catalog/backend.md or .claude/catalog/frontend.md if this is genuinely new and not already catalogued."
  }
}
EOF
fi
